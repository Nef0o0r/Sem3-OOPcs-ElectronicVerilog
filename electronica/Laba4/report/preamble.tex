...
\NewDocumentCommand\pic{O{ht}O{70mm}mm} % Вставка изображения
{
	\begin{figure}[#1]
		\centering
...
% \usepackage{utf8} % Поддержка UTF-8
%
\setmonofont{PT Mono}
%
% \lstset{
...
%     inputencoding=utf8,
%     language=C,
%     % commentstyle=\color{grey}, % Цвет комментариев
% }
